...
[_RAISE] = LAYOUT( \
  ...
  KC_PGUP, _______, _______, _______, _______, _______, _______, KC_F12, KC_PLUS,  KC_MINS,     KC_EQL,    KC_LBRC, KC_RBRC, KC_PGDN, \
                             _______, _______, _______, _______, _______, _______, _______, _______\
),
 ...
 */
  [_ADJUST] = LAYOUT( \
    RGB_TOG, RGB_MOD, _______, _______, _______, _______,                   KC_7, KC_8,   KC_9,    KC_PAST, KC_PSLS, KC_DEL, \
    RGB_SAD, RGB_SAI, _______, _______, _______, _______,                   KC_4, KC_5,   KC_6,    KC_PPLS, _______, _______,\
    RGB_VAD, RGB_VAI, _______, _______, _______, _______,                   KC_1, KC_2,   KC_3,    KC_PMNS, KC_UP,   _______,\
    RGB_HUD, RGB_HUI, _______, _______, _______, _______, _______, _______, KC_0, KC_DOT, KC_PEQL, KC_LEFT, KC_DOWN, KC_RGHT,\
                               _______, _______, _______, _______, _______, _______, _______, _______\
  )
};
